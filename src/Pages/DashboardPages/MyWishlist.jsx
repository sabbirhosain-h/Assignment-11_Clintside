             ...
             <motion.div
                ...
                //   transition= {{ delay: index * 0.05 }}
                  ...
                  <div className="flex gap-5 mb-3">
                    ...
                    <img   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9AXD49XCs-BzwfBp99gCr60hs1WKc29RHbg&s"
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-sm   dark:text-white text-slate-900">5.55</span>
                        </div>
                      </div>
