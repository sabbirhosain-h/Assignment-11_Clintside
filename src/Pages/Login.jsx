               ...
               className="flex flex-col items-center justify-center w-80 md:w-125 rounded-2xl shadow-xl p-8 border border-slate-200 px-4 py-3 dark:bg-slate-800 dark:border-slate-700 mt-10 mb-10">
                ...
                <form className="w-full mt-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="password" id="password" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="••••••••" />
                    </div>
                    <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-md transition duration-300">Sign In</button>
                </form>
