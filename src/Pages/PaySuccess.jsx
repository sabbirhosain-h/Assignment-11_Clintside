...
import Load from './Load';
 ...
 const PaySuccess = () => {
    ...
    if (!pageData) return <Load></Load>;

   
    const price = `${pageData.price} BDT`;
    const raw = pageData.date.split("T")[0];

     const rows = [
         { label: "Payment ID:", value: pageData.orderId , bold: false },
         { label: "Book:", value: pageData.bookName, bold: true },
         { label: "Amount:", value: price , bold: true },
         { label: "Date:", value: raw, bold: false },
     ];
